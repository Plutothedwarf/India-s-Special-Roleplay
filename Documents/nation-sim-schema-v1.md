...
This app is pinned to Azgaar Fantasy Map Generator version 1.148.4, self-hosted in public/azgaar. Only .map files generated by this exact version (or a compatible one) will load correctly — files from a different version (e.g. the public Azgaar website, if it's running a different version) may fail with version/format errors. To generate a guaranteed-compatible map, use our self-hosted instance directly at http://localhost:3000/azgaar/dist/index.html rather than the public Azgaar site.
